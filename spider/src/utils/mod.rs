...
#[cfg(all(not(feature = "rquest"), not(feature = "cache_request")))]
...
#[cfg(feature = "cookies")]
pub fn get_cookies(res: &Response) -> Option<crate::client::request_client::header::HeaderMap> {
    let mut headers = crate::client::request_client::header::HeaderMap::new();
