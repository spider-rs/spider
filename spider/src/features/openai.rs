...
const PROMPT_EXTRA: &str = r#"Return content in JSON: {"content": ["Something"], "js": "window.location.href = 'https://www.google.com/search?q=Movies';"}. Always use this structure. If no JS is needed, set "js" to an empty string."#;
