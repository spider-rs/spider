...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.14", features = ["budget"] }
```
