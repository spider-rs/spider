...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.77", features = ["budget"] }
```
