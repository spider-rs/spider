...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.34", features = ["budget"] }
```
