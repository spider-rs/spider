...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.67", features = ["budget"] }
```
