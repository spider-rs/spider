...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.15", features = ["openai"] }
```
