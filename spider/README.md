...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.65", features = ["budget"] }
```
