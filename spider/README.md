...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.66", features = ["budget"] }
```
