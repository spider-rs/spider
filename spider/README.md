...
```toml
[dependencies]
spider = { version = "1.49.9", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.9", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.9", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.9", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.9", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.9", features = ["chrome"] }
```
