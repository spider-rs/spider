...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.28", features = ["openai"] }
```
