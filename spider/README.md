...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.6", features = ["budget"] }
```
