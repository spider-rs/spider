...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.68", features = ["budget"] }
```
