...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.22", features = ["budget"] }
```
