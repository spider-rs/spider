...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.64", features = ["budget"] }
```
