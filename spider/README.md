...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.61", features = ["budget"] }
```
