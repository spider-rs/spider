...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.12", features = ["openai"] }
```
