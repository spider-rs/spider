...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.19", features = ["openai"] }
```
