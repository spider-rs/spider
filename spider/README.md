...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.8", features = ["budget"] }
```
