...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.47", features = ["budget"] }
```
