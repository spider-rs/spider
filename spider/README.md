...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "2.0.8", features = ["openai"] }
```
