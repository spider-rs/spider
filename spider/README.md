...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.20", features = ["openai"] }
```
