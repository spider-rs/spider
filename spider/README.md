...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.57", features = ["budget"] }
```
