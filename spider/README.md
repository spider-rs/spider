...
```toml
[dependencies]
spider = { version = "1.45.4", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.4", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.4", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.4", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.4", features = ["control"] }
```
