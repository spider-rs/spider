...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.70", features = ["budget"] }
```
