...
```toml
[dependencies]
spider = { version = "1.49.3", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.3", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.3", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.3", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.49.3", features = ["control"] }
```
