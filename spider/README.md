...
```toml
[dependencies]
spider = { version = "1.30.11", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.30.11", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.30.11", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.30.11", features = ["control"] }
```
