...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.81", features = ["budget"] }
```
