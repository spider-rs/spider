...
```toml
[dependencies]
spider = { version = "1.31.3", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.3", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.3", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.3", features = ["control"] }
```
