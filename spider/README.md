...
```toml
[dependencies]
spider = { version = "1.28.4", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.28.4", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.28.4", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.28.4", features = ["sequential"] }
```
