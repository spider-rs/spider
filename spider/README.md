...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.9", features = ["budget"] }
```
