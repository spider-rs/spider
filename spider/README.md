...
```toml
[dependencies]
spider = { version = "1.31.5", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.5", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.5", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.5", features = ["control"] }
```
