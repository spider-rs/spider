...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.78", features = ["budget"] }
```
