...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.7", features = ["budget"] }
```
