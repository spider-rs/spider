...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.85", features = ["budget"] }
```
