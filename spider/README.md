...
```toml
[dependencies]
spider = { version = "1.35.1", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.35.1", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.35.1", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.35.1", features = ["control"] }
```
