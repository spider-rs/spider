...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.31", features = ["budget"] }
```
