...
```toml
[dependencies]
spider = { version = "1.31.2", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.2", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.2", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.2", features = ["control"] }
```
