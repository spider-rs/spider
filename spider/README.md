...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.10", features = ["budget"] }
```
