...
```toml
[dependencies]
spider = { version = "1.50.14", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.50.14", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.50.14", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.50.14", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.50.14", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.50.14", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.50.14", features = ["chrome"] }
```
