...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.76", features = ["budget"] }
```
