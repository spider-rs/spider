...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.24", features = ["budget"] }
```
