...
```toml
[dependencies]
spider = { version = "1.28.0", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.28.0", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.28.0", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.28.0", features = ["sequential"] }
```
