...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.30", features = ["budget"] }
```
