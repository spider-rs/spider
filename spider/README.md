...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.55", features = ["budget"] }
```
