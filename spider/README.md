...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.69", features = ["budget"] }
```
