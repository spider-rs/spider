...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.45", features = ["budget"] }
```
