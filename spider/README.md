...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.86.4", features = ["budget"] }
```
