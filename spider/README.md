...
```toml
[dependencies]
spider = { version = "1.45.8", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.8", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.8", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.8", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.8", features = ["control"] }
```
