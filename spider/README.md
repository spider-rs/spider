...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.27", features = ["budget"] }
```
