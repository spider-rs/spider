...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.82", features = ["budget"] }
```
