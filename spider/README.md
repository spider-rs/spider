...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.75", features = ["budget"] }
```
