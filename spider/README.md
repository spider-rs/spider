...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.72", features = ["budget"] }
```
