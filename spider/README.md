...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.21", features = ["budget"] }
```
