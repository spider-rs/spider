...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.35", features = ["budget"] }
```
