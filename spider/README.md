...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.58", features = ["budget"] }
```
