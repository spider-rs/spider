...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.74", features = ["budget"] }
```
