...
```toml
[dependencies]
spider = { version = "1.31.6", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.6", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.6", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.31.6", features = ["control"] }
```
