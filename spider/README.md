...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.40", features = ["budget"] }
```
