...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.16", features = ["smart"] }
```
