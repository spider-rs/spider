...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.37", features = ["budget"] }
```
