...
```toml
[dependencies]
spider = { version = "1.43.0", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.43.0", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.43.0", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.43.0", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.43.0", features = ["control"] }
```
