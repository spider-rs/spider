...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.2", features = ["budget"] }
```
