...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.95.26", features = ["budget"] }
```
