...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.79", features = ["budget"] }
```
