...
```toml
[dependencies]
spider = { version = "1.45.5", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.5", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.5", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.5", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.45.5", features = ["control"] }
```
