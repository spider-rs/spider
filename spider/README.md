...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.29", features = ["budget"] }
```
