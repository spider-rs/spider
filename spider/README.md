...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.17", features = ["openai"] }
```
