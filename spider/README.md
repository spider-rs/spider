...
```toml
[dependencies]
spider = { version = "1.48.1", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.48.1", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.48.1", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.48.1", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.48.1", features = ["control"] }
```
