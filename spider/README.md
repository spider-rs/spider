...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.33", features = ["budget"] }
```
