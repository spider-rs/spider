...
```toml
[dependencies]
spider = { version = "1.51.0", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.51.0", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.51.0", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.51.0", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.51.0", features = ["control"] }
```
...
Use chrome CDP to crawl pages that require Javascript.

```toml
[dependencies]
spider = { version = "1.51.0", features = ["chrome"] }
```
