...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.83", features = ["budget"] }
```
