...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.73", features = ["budget"] }
```
