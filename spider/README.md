...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.84", features = ["budget"] }
```
