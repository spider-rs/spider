...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.11", features = ["smart"] }
```
