...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["regex", "ua_generator"] }
```
...
1. `spoof`: Spoof HTTP headers for the request.
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.32", features = ["budget"] }
```
