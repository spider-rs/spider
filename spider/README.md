...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.43", features = ["budget"] }
```
