...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.99.25", features = ["openai"] }
```
