...
```toml
[dependencies]
spider = { version = "1.30.10", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.30.10", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.30.10", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.30.10", features = ["control"] }
```
