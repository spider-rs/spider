...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.63", features = ["budget"] }
```
