...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.1", features = ["budget"] }
```
