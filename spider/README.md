...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.80", features = ["budget"] }
```
