...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.18", features = ["smart"] }
```
