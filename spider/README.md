...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.71", features = ["budget"] }
```
