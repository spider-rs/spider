...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.41", features = ["budget"] }
```
