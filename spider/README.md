...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.46", features = ["budget"] }
```
