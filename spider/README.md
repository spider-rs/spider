...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.84.3", features = ["budget"] }
```
