...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["openai"] }
```
...
```toml
[dependencies]
spider = { version = "1.93.38", features = ["budget"] }
```
