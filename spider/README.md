...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.5", features = ["smart"] }
```
