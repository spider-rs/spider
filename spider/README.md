...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.97.13", features = ["openai"] }
```
