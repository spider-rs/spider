...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["regex", "ua_generator"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["decentralized"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["sync"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["regex"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["control"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["sync", "cron"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["chrome", "chrome_intercept"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["cache"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["smart"] }
```
...
```toml
[dependencies]
spider = { version = "1.80.36", features = ["budget"] }
```
